...
void GraphicsArenaViewer::DrawSensor(
  ...
  // sensor cone outline
  nvgSave(ctx);
  nvgRotate(ctx, 0.5*sensor_ang);
  nvgBeginPath(ctx);
  nvgMoveTo(ctx, 0.0, 0.0);
  nvgLineTo(ctx, sensor_dis, 0.0);
  nvgArc(ctx, 0.0, 0.0, sensor_dis , 0.0, -sensor_ang, NVG_CCW);
  ...
  nvgMoveTo(ctx, 0.0, 0.0);
  nvgLineTo(ctx, sensor_dis, 0.0);
  nvgArc(ctx, 0.0, 0.0, sensor_dis , 0.0, -0.5 * sensor_ang, NVG_CCW);
  nvgLineTo(ctx, 0.0, 0.0);
