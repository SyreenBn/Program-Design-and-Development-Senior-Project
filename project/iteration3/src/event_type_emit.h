 ...
 ******************************************************************************/
/**
 * @brief The event type emit is a  class to check the event the entity and
 * provide information regarding the entities involved and the location of the
 * event.
 */
...
class EventEntityTypeEmit : public EventBaseClass {
 public:
  ...
  /*
   * @brief  return ture if the event is emited and false if not
   */
  bool Emitted(void) { return emitted_; }
  void Emitted(bool e) { emitted_ = e; }

 /*
   * @brief  this fuction is to the position of contact of the event
   */
  Position point_of_contact() { return point_of_contact_; }
  void point_of_contact(Position p) { point_of_contact_ = p; }

  /*
   * @brief this fuction is to the angle of contact of the event
   */
