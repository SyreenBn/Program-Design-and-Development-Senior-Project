...
/**
 * @brief A representation of a sensor_proximity. proximate sensors are
 * "active" when pressed. For our purposes, imagine a series of proximate sensors
  * around the perimeter of the robot. A proximity will activate the sensor
...
~SensorProximity() {}
  ...
  /*
   * this funciton is the to tell the user if the sensor is on or off,
   * check if it is activiaed or not
   */
