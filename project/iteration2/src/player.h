...
/* accept the command event to chage the speed and th heading angle */
  ...
  const std::string& namei(void) const {
     ...
     * setendGame : write the status of the User
     * endGame return the staus of the user to print it on the window
     */
  ...
  std::string endGame(void) const { return endGame_; }
  void setendGame(std::string s) {endGame_ = s;}
  /*
