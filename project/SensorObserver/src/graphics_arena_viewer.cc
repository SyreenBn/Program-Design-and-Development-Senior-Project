 ...
 ******************************************************************************/
   ...
   */
  nvgText(ctx, 0.0, 50.0, player->loseGame().c_str(), NULL);
...
void GraphicsArenaViewer::DrawSensor(
  ...
  nvgRotate(ctx, robot -> heading_angle()+(angle*2));

  // sensor cone outline
  nvgSave(ctx);
  nvgRotate(ctx, robot -> heading_angle());
  nvgBeginPath(ctx);
  nvgMoveTo(ctx, 0.0, -90.0);
  nvgLineTo(ctx, 0.0, 0.0);
  nvgMoveTo(ctx, -30.0, -85.0);
  nvgLineTo(ctx, 0.0, 0.0);
  nvgMoveTo(ctx, 30.0, -85.0);
  nvgLineTo(ctx, 0.0, 0.0);
  nvgArc(ctx, 0.0, -85.0, 30.0, 0.0, 0, NVG_CCW);
  ...
  nvgMoveTo(ctx, -30.0, -85.0);
  nvgLineTo(ctx, 0.0, 0.0);
  nvgArc(ctx, 0.0, -90.0, 1.0, 0.0, 10, NVG_CCW);
  nvgRestore(ctx);
  ...
  nvgLineTo(ctx, 30.0, -85.0);
  // nvgMoveTo(ctx, 30.0, -85.0);
  nvgArc(ctx, 0.0, -90.0, 0.0, 10.0, -10, NVG_CCW);
  nvgRestore(ctx);
