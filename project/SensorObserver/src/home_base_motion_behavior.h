/**
 * @file home_base_motion_behavior.h
 *
 * @copyright 2017 3081 Staff, All rights reserved.
 */
#ifndef SRC_HOME_BASE_MOTION_BEHAVIOR_H_
#define SRC_HOME_BASE_MOTION_BEHAVIOR_H_
...
class HomeBaseMotionBehavior {
 public:
  ...
  /* this funcion to reset the hoem base to the original place
   * when the user restart the game
   */
  void UpdateOriginPosition(class ArenaMobileEntity * const ent);
 private:
  int change_angle = 0;
  int max_change_angle = 10;
};

/*! Namespaces End */
NAMESPACE_END(csci3081);

#endif  // SRC_HOME_BASE_MOTION_BEHAVIOR_H_
