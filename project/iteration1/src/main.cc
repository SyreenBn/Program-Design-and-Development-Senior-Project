...
int main(int, char **) {
  ...
  hparams.angle_delta = 20;
  hparams.collision_delta = 1;
  hparams.radius = 20.0;
  hparams.pos = Position(400, 400);
  hparams.color = csci3081::Color(255, 0, 0, 255); /* red */

  csci3081::arena_params aparams;
  /*
   * we add aparams homebase to make the home base move adn the we did
  ...
  aparams.obstacles[1].pos = {700, 400};
  aparams.obstacles[1].color = csci3081::Color(255, 255, 255, 255); /* white */

  aparams.obstacles[2].radius = 40.0;
  aparams.obstacles[2].pos = {200, 400};
  ...
  aparams.obstacles[4].radius = 25.0;
  aparams.obstacles[4].pos = {500, 700};
