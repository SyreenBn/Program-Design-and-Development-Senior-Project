...
/**
 * @file home_base_sensor_touch.h
 *
 * @copyright 2017 3081 Staff, All rights reserved.
 */
#ifndef SRC_HOME_BASE_SENSOR_TOUCH_H_
#define SRC_HOME_BASE_SENSOR_TOUCH_H_
...
class ArenaEntity;
/**
 * @brief A representation of a home base touch sensor. Touch or "bump" sensors
 * are "active" when pressed. For our purposes, imagine a series of bump sensors
...
class HomeBaseSensorTouch :  public Sensor {
 public:
  HomeBaseSensorTouch();
...
#endif  // SRC_HOME_BASE_SENSOR_TOUCH_H_
